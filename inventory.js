...
<!-- Add Batch Modal -->
<!-- ===================== -->
<div id="add-batch-modal" class="overlay" style="display:none;">
  <div class="card" style="max-width:420px;">
    <div class="modal-header">
      <h2>Add batch</h2>
      <button id="close-add-batch" aria-label="Close">×</button>
    </div>

    <div class="modal-body">
      <form id="add-batch-form">
        <!-- These are populated dynamically -->
        <input type="hidden" id="batch-gel-name">
        <input type="hidden" id="batch-gel-carbs">
        <input type="hidden" id="batch-gel-caff">

        <label>
          <span>Expiry date (DD/MM/YY)</span>
          <input id="batch-expiry" placeholder="DD/MM/YY" required>
        </label>

        <label>
          <span>Quantity</span>
          <input id="batch-qty" type="number" min="1" step="1" required>
        </label>
