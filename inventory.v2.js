...
(function(){
  var LS_KEY', renderTable); }  var LS_KEY = 'bikeFuelPlanner.gelInventory.v1';
  ...
  function loadInventory(){
    try{ var x=localStorage.getItem(LS_KEY); return x?JSON.parse(x):[]; }catch(e){ return []; }
  }
  ...
  function allocateSmart(requiredCarbs, opts){
    ...
    var raw = loadInventory(); var list=[];
  ...
  function wireForm(){
    var form = $('inventory-form'); if(!form) return;
